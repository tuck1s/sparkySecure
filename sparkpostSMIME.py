...
def buildSMIMEemail(msg, encrypt=False, sign=False):
    ...
    copyPayload(fixTextPlainParts(msg), msg)
    # Sign the message, replacing it in-situ
    if sign:
        msg = signEmailFrom(msg, fromAddr)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--send_api', action='store_true', help='Send via SparkPost API (using env var SPARKPOST_API_KEY).')
